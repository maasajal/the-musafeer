      ...
      <div className="container mx-auto px-6">
          ...
          >
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+358466120140" className="hover:text-green-500">
                  +358 44 986 9280 or
                </a>
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <a
                  href="mailto:abdullah@themusafeer.com"
                  className="hover:text-green-500"
                >
                  abdullah@themusafeer.com
                </a>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-center gap-5">
          ...
          <p className="text-sm">
            ...
            >
              <span className="text-blue-300">BusinessEasy.</span>
            </Link>{" "}
            All right reserved.
          </p>
...
//             </a>
//             <a
//               href="tel:+358466120140"
//               className="link link-hover flex items-center justify-center gap-2"
//             >
//               <FaWhatsapp className="text-lg" /> +358466120140
//             </a>
//             <a
//               href="mailto:abdullah@easyaccount.fi"
//               className="link link-hover flex items-center justify-center gap-2"
//             >
